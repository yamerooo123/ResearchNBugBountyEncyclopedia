...
สำหรับวิธีการเตรียมตัว OSCP ผมเก็บ 10% ก่อนเลยกลัวว่าถ้าเคสแบบแฮค AD ไม่ได้คือจบเห่อย่างเดียวผมอยากเปิดออฟชั่นให้กับตัวเองเลยเลือกรูทนี้ ใช้เวลา 1 เดือนครึ่งในการเก็บ 30 challenged flags ถ้าใครคิดว่าตัวเองแค่อยากผ่านง่ายๆและมีความรู้พอผมแนะนำเข้าไปที่ OffSeec Discord ใน Search ค้นหาคีย์เวิร์ด Medtech or Relia AD domain admin hashes คุณจะได้เกือบ 20 flags ที่เหลือทำ OSCP A B C เพราะ 3 เซ็ตนี้คือเครื่องสอบที่เขา retired เรียบร้อยแล้ว(ทริคนี้ใช้ได้ถึง 31 ตุลา 2024 นะ)
...
**ทิปที่ 6: ใช้ [penelope](https://github.com/brightio/penelope) สำหรับ shell handler สำหรับ reverse shell จะทำให้ชีวิตคุณสบายขึ้นเยอะ555 (คิดซะว่ามันคือ netcat shell ที่เราไม่ต้องรัน3-4คอมแมนเพื่อให้ได้ full-interactive shell)**
