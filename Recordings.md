...
แต่มีความชอบในเรื่องการแฮคผมเลยหาเวลาว่างมานั่งเรียนเอง ในส่วนพื้นฐานผมมีความรู้ด้าน web dev และ technical assistant ผ่านโปรเจ็คมหาลัยและประสบการณ์งาน part time
...
![image](https://github.com/user-attachments/assets/bf2fd5df-fc51-45b8-97b7-6e28747ac97f)
...
<h1>October 2024: Dream Comes True</h1>
...
แต่ช่วงนั้นเองผมก็หางานไปด้วยโดย resume template ที่ผมใช้ผมใช้ของ UnixGuy หาโหลดได้จากหน้า YouTube พี่แกเลยผมเริ่มหางานตั้งแต่เดือนกันยายนตลอดเดือนจนถึงตุลาคม ในที่สุดผมได้รับการติดต่อมาจาก 4 ที่(3 ตำแหน่ง Penetration tester และ 1 ตำแหน่ง Security Analyst) 2 ที่ offer ให้ผมเลยส่วนอีก 2 ที่นัดสัมภาษภ์กับสนใจนิดหน่อย ตอนนั้นรู้สึกว่าสิ่งที่ผมทำมาตลอด 1 ปีมันเห็นผลแล้วผมรู้สึกดีมากๆ ผมรู้สึกว่าตัวเองมีคุณค่า สุดท้ายแล้วผมก็ตอบตกลงเซ็นสัญญากับบริษัทนึงในฐานะ Penetration Tester 

<h3>วันอาทิตย์ที่ 20 ตุลาคมประมาณ 3 ทุ่มผมเข้าไปเช็คผ่านเว็ป OffSec ปรากฎว่าผมผ่าน OSCP! แต่อีเมลยังไม่เข้า</h3>

![image](https://github.com/user-attachments/assets/e6e8c26b-0cec-4bc0-8a78-8f6ddb9d1c79)


ผ่านไป 1 ชม. ในที่สุดผมก็ได้รับจดหมายจาก OffSec! (ตามจริงถ้าในหน้า OffSec เขียนว่า Congratulation เราสามารถเข้าไปเคลมใบเซอร์ได้เลยโดยไม่ต้องรออีเมลทางการจาก OffSec)

![image](https://github.com/user-attachments/assets/bd94d06b-d70e-4320-b84e-dcfe66685e59)
...
**ทิปที่ 6: ใช้ [penelope](https://github.com/brightio/penelope) สำหรับ shell handler ตอน reverse shell จะทำให้ชีวิตคุณสบายขึ้นเยอะ555 (คิดซะว่ามันคือ netcat shell ที่เราไม่ต้องรัน3-4คอมแมนเพื่อให้ได้ full-interactive shell) วิธีการรันก็แค่ sudo ./penelope.py 80(หรือ sudo python3 penelope.py 80 ถ้าไม่ได้ chmod +x penelope.py) ถ้ามีปัญหา shell บัคให้ sudo lsof -i :<พอร์ท> แล้วก็ sudo kill <PID> หรือ sudo kill -9 <PID> ถ้าคอมแมนแรกไม่ติด easy peasy lemon squeezy!**

![image](https://github.com/user-attachments/assets/cd2cb80a-9966-4a14-bce7-c2da9f6439b8)
...
**PS:ในปีที่ 2 ผมมีแพลนที่จะสอบ OSWE ปลายปี, หา 5 CVE, เน้นหาความรู้การเจาะเว็ปไซต์กับแอปทรส. และว่างๆจะเรียนรู้เรื่องของ kernel exploitation โดยเฉพาะ Windows (เผื่อหาเจอ อยากมีโมเม้นขึ้นไปพรีเซ้นเท่ๆในเวที Defcon 555หยอกๆ)**


![Capture](https://github.com/user-attachments/assets/79c2ae5e-9133-4a1f-9ef1-4c8012c23b23)
